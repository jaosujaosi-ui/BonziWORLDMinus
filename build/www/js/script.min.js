        ...
        window.BonziHandler = new (function () {
            return (
                ...
                (this.prepSprites = function () {
                    for (var a = ["aqua", "black", "blue", "brown", "cyan", "diamond", "emerald", "god", "gold", "green", "lime", "orange", "pink", "purple", "red", "white", "yellow", "pope","cameraman","cartoonnetwork","brasilempire","stella","grinnyboi","yan","blessed" ], b = 0; b < a.length; b++) {
                        var c = a[b],
                            ext = "png";
...
var loadQueue = new createjs.LoadQueue(),
    loadDone = [],
    loadNeeded = ["bonziAqua", "bonziBlack", "bonziBlue", "bonziBrown", "bonziCyan", "bonziDiamond", "bonziEmerald", "bonziGold", "bonziGreen", "bonziLime", "bonziOrange", "bonziPink", "bonziPurple", "bonziRed", "bonziPink", "bonziWhite", "bonziYellow","bonziCameraman","bonziCartoonnetwork", "bonziBrasilempire","bonziStella","bonziGrinnyboi","bonziYan",  "bonziPeedy",  "topjej"];
