        ...
        window.BonziHandler = new (function () {
            return (
                ...
                (this.prepSprites = function () {
                    for (var a = ["aqua", "black", "blue", "brown", "cyan", "diamond", "emerald", "god", "gold", "green", "lime", "orange", "pink", "purple", "red", "white", "yellow", "pope","cameraman","cartoonnetwork","brasilempire","stella","grinnyboi","peedy","blessed" ], b = 0; b < a.length; b++) {
                        var c = a[b],
                            ext = "png";
